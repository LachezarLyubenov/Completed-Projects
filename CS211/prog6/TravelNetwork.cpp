...
void TravelNetwork::doList()
{
        ...
        printf ("Performing the List Command from %d to %d\n",
                val1, val2);
...
void TravelNetwork::doFile()
{
        ...
        //  1. verify the file name is not currently in use
        //  DONE: 2. open the file using fopen creating a new instance of FILE*
        //  DONE: 3. recursively call processCommandLoop() with this new instance of FILE* as the parameter
        //  DONE: 4. close the file when processCommandLoop() returns
}
